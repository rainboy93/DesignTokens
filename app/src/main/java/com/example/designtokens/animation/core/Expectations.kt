...
import com.example.designtokens.animation.GravityIntDef
import com.example.designtokens.animation.GravityScaleHorizontalIntDef
import com.example.designtokens.animation.GravityScaleVerticalIntDef
import com.example.designtokens.animation.PleaseAnim
import com.example.designtokens.animation.core.alpha.AlphaAnimExpectation
import com.example.designtokens.animation.core.alpha.AlphaAnimExpectationValue
import com.example.designtokens.animation.core.custom.CustomAnimExpectation
import com.example.designtokens.animation.core.custom.TextColorAnimExpectation
import com.example.designtokens.animation.core.custom.TextSizeAnimExpectation
import com.example.designtokens.animation.core.custom.ViewBackgroundAlphaAnimExpectation
import com.example.designtokens.animation.core.margins.Margin
import com.example.designtokens.animation.core.margins.MarginSetAnimExpectation
import com.example.designtokens.animation.core.paddings.Padding
import com.example.designtokens.animation.core.paddings.PaddingSetAnimExpectation
import com.example.designtokens.animation.core.position.*
import com.example.designtokens.animation.core.rotation.RotationExpectation
import com.example.designtokens.animation.core.rotation.RotationExpectationOriginal
import com.example.designtokens.animation.core.rotation.RotationExpectationValue
import com.example.designtokens.animation.core.rotation.RotationFlipExpectationValue
import com.example.designtokens.animation.core.scale.*
...
class Expectations(private val pleaseAnim: PleaseAnim) {
  ...
  fun sameCenterVerticalAs(view: View): PositionAnimExpectation {
    return sameCenterAs(view, horizontal = false, vertical = true).apply {
      expectations.add(this)
    }
  }
  ...
  fun centerVerticalInParent(): PositionAnimExpectation {
    return centerInParent(horizontal = false, vertical = true).apply {
      expectations.add(this)
    }
  }

  fun centerHorizontalInParent(): PositionAnimExpectation {
    return centerInParent(horizontal = true, vertical = false).apply {
      expectations.add(this)
    }
  }
